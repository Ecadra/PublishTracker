...
class Autor(models.Model):
    ...
    def set_nombre(self, nombre):
        """Setter para nombre con formateo"""
    ...
    def set_orcid(self, orcid):
        """Setter para ORCID con validación y formateo"""
        if orcid:
...
class Rol(models.Model):
    ...
    def descripcion_corta(self):
        return self.descripcion[:50] + "..." if self.descripcion and len(self.descripcion) > 50 else (self.descripcion or "Sin descripción")
...
class PaperAutor(models.Model):
    """Modelo para relación many-to-many entre Paper y Autor con orden"""
    ...
    def es_autor_correspondiente(self):
        """Optimizado para reducir consultas en listas grandes"""
